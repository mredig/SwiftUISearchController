...
extension View {
	func navigationBarSearch(
		_ searchQuery: SearchBar.QueryData,
		...
		overlay(
			SearchBar.Injector(searchQueryData: searchQuery)
...
enum SearchBar {
	...
	*/
	struct Injector: UIViewControllerRepresentable {
		let searchQueryData: SearchBar.QueryData
		...
		class Coordinator: NSObject, UISearchResultsUpdating {
			let parent: SearchBar.Injector
			let searchController: UISearchController

			private var subs: Set<AnyCancellable> = []

			init(parent: SearchBar.Injector, searchController: UISearchController) {
				self.parent = parent
	...
	class QueryData: ObservableObject {
		...
		static func == (lhs: QueryData, rhs: UISearchBar) -> Bool {
